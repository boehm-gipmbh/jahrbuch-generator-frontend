...
export const ForgotUsername = () => {
  ...
  const sendReminder = () => {
    ...
    setLoading(true);
    fetch(`${process.env.REACT_APP_API_URL}/auth/forgot-username`, {
      method: 'POST',
      ...
      <Container maxWidth="xs">
        <Box sx={{mt: 8, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2}}>
          ...
          <Alert severity="success">
            Falls diese E-Mail-Adresse registriert ist, wurde dein Benutzername gesendet.
    ...
    <Container maxWidth="xs">
      <Box sx={{mt: 8, display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{mt: 1, textAlign: 'center'}}>
          Gib deine E-Mail-Adresse ein. Wir schicken dir deinen Benutzernamen.
        </Typography>
        <Box noValidate sx={{mt: 2, width: '100%'}}>
          ...
          />
          <Button
            fullWidth variant="contained" onClick={sendReminder}
